      ...
      <View style={styles.container}>
        ...
        <View style={styles.inputContainer}>
          ...
          <TouchableOpacity style={styles.sendButton} onPress={enviarMensagem}>
            <Image source={require('../assets/send.png')} style={styles.sendButtonImage} />
          </TouchableOpacity>
        </View>
        <TouchableOpacity style={styles.navigateToReceive} onPress={() => navigation.navigate('ReceiveMessages')}>
          <Text style={styles.navigateToReceiveText}>Ver Mensagens</Text>
        </TouchableOpacity>
      </View>
    </LinearGradient>
  );
